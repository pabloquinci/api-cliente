...
public class ControllerAdvice {
    ...
    protected ResponseEntity<String> userException(UserNotFoundExcdeption ex){
        return new ResponseEntity<>("Error: El usuario que quiere editar o actualizar no existe", HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(UserAlreadyExistsException.class)
    protected ResponseEntity<String> userAlreadyException(UserAlreadyExistsException ex){
        return new ResponseEntity<>("Error: Ya existe el usuario con ese DNI", HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(Exception.class)
    protected ResponseEntity<String> userAlreadyException(Exception ex){
        return new ResponseEntity<>("Error: Respuesta solicitud usuario", HttpStatus.INTERNAL_SERVER_ERROR);
    }
